			...
			for i := range pclns {
				...
				if i == 0 {
					if file == "<autogenerated>" {
						// This is the autogenerated function.
						// We SHOULD NOT be called the addFunc() and addLine().
						log.Println(hex(rawfn.entry), " func: name=", fname, " skipped")
						break
					}
					// This is not autogenerated function.
					// We SHOULD call the addFunc() and addLine().
